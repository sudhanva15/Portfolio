...
export default function AboutPage() {
  ...
  const aboutFacts = funFacts
    .filter((f) => ["childhood-giraffes", "bike-fixing", "vr-whiteboard", "racing-sim-retro", "trails-photography"].includes(f.id))
    .slice(0, 4);
  ...
  const fieldNotes = [
    ...
    "I haven't visited some wildlife reserves or coastal towns yet. I&apos;m endlessly curious about places I haven't explored, and that same curiosity drives how I approach new datasets, industries, and product problems.",
  ];
  return (
