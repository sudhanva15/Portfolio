  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body
        ...
        // Server-side dark fallback so initial paint matches toggled dark theme
        className={cn(inter.variable, "min-h-screen font-sans antialiased text-slate-900 dark:text-slate-100")}
      >
