      ...
      <section className="border-b border-transparent py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-0">
          ...
          <p className="mt-4 max-w-3xl text-lg leading-relaxed text-gray-700 dark:text-gray-300">
            A closer look at the product, analytics, and systems work I have led—from ETF intelligence engines to operational command centers. Each project pairs structured thinking with calm, transparent execution.
          </p>
        </div>
      </section>
